                        ...
                        <table class="w-full min-w-max divide-y-2 divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                <tr class="*:text-gray-900 *:midle:font-medium dark:*:text-white text-left">
                                    ...
                                    <td class="px-3 py-2">Oct 27</td>
                                    <td class="px-3 py-2">
                                        <div class="flex flex-wrap gap-2">
                                            <a href="{{ route('admin.transaction.show', 1) }}"
                                                class="inline-block rounded-lg bg-green-600 px-4 py-2 text-sm font-medium text-white shadow hover:bg-green-700 focus:outline-none focus:ring focus:ring-green-300 transition">
                                                Show
                                            </a>
                                            ...
                                            <button type="button" @click="openModal = true"
                                                class="inline-block rounded-lg bg-red-600 px-4 py-2 text-sm font-medium text-white shadow hover:bg-red-700 focus:outline-none focus:ring focus:ring-red-300 transition">
                                                Delete
                                            </button>
                                        </div>
                                    </td>
