            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @elseif (session()->has('error'))
                        <div x-data="{ show: true }" x-show="show" x-transition role="alert"
                            class="border-s-4 border-red-700 bg-red-50 p-4 mb-5 relative">
                            ...
                            <!-- Tombol tutup -->
                            <button @click="show = false"
                                class="absolute top-2 right-2 rounded-full p-1 text-red-700 hover:bg-red-100 transition"
                                type="button" aria-label="Dismiss alert">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    @foreach ($categories as $index => $item)
                                                ...
                                                <div class="flex gap-3">
                                                    ...
                                                    <a href="{{ route('admin.category.edit', $item->category_id) }}"
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            ...
                                                            class="w-8 h-8">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                d="M15.232 5.232l3.536 3.536M9 11l6.536-6.536a2 2 0 112.828 2.828L11.828 13.828a2 2 0 01-1.414.586H8v-2.414a2 2 0 01.586-1.414z" />
                                                        </svg>
                                                    </a>
                                                    <button type="button"
                                        ...
                                        <div x-show="openModal" x-cloak x-transition
                                            ...
                                            <div
                                                ...
                                                <h2 class="text-xl font-bold text-gray-900 dark:text-gray-100">Confirm
                                                    Delete</h2>
